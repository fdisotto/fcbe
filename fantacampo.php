...
if ( $_SESSION[ 'utente' ] == $_GET[ 'iutente' ] ) {
    ...
    if ( @$ultima_giornata >= 1 and file_exists( $percorso_cartella_voti . "/voti$ultima_giornata.txt" ) ) {
        ...
        if ( isset( $test ) ) {
            if ( is_file( "$percorso_cartella_dati/calciatori.txt" ) )
                echo "Uso file: $percorso_cartella_dati/calciatori.txt<br />"; else echo "Non trovato file: $percorso_cartella_dati/calciatori.txt<br />";
        }
    }
	...
	test: $test<br />";
        ...
        if ( file_exists( "$percorso_cartella_dati/squadre.txt" ) )
            echo "Esiste il file $percorso_cartella_dati/squadre.txt<br /><br />"; else echo "Non esiste il file $percorso_cartella_dati/squadre.txt<br />";
