...
if ($_SESSION['valido'] == "SI" and $_SESSION['permessi'] >= 4) {
	...
	if ($copia_file_voti and $posizione_file) {
		...
		if (@is_file($percorso_cartella_voti."/voti".$giornata.".txt")) {
			echo "<center><h4>File gi� esistente, non copiato.</h4></center>";
			$copiare = "NO";
	...
	for ($num = 1 ; $num < $num_tornei; $num++) {
		...
		unset($outente, $opass, $opermessi, $oemail, $ourl, $osquadra, $otorneo, $oserie, $ocitt�, $ocrediti, $ovariazioni, $ocambi, $oreg);
		...
		for($num1 = 1 ; $num1 < $linee; $num1++) {
			@list($outente, $opass, $opermessi, $oemail, $ourl, $osquadra, $otorneo, $oserie, $ocitt�, $ocrediti, $ovariazioni, $ocambi, $oreg) = explode("<del>", $fileu[$num1]);
