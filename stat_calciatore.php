...
if ($xsquadra) $tabstat .= "<td class='testa'>Squadra</td>";
...
if ($xsquadra) $tabstat .= "<td align='center'><a href='tab_squadre.php?vedi_squadra=$xsquadra&amp;escludi_controllo=$escludi_controllo' class='user'>$xsquadra</a></td>";
