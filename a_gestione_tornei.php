...
if ($_SESSION['valido'] == "SI" and $_SESSION['permessi'] == 5) {
	...
	if ($otstato == "B") echo "<td><img src='immagini/email.gif' alt='Apri buste' width='32' height='32' /></td>";
	echo "</tr>
	<tr align='center' valign='middle'>
	...
	if ($otstato == "B") echo "<td><a href='a_gestione_tornei.php?itorneo=$itorneo&amp;opzione=6'>Buste</a></td>";

	if ($otstato == "B") echo "</tr><tr><td colspan='6' align='left'>";
	else echo "</tr><tr><td colspan='5' align='left'>";
	echo "<br/><br/><br/><b><u>Riepilogo informazioni:</u/></b><br/>
	Ci sono <b>".count($a_utenti)."</b> giocatori registrati.<br/>
	$mess1<br/>
	$mess2<br/>
	$mess3<br/>
	<div style='color: #DDDDDD; text-align: right'>$itorneo $opzione</div>
	</td></tr>
	</table>";
