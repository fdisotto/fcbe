...
if ( $_SESSION[ 'valido' ] == "SI" and $_SESSION[ 'permessi' ] == 5 ) {
    ...
    if ( isset( $opzione ) && $opzione == 1 ) {
        ...
        for ( $num1 = 1; $num1 < $linee; $num1++ ) {
            ...
            if ( file_exists( $percorso_cartella_dati . "/squadra_$outente" ) )
                $ums = "<br />- modifica formazione: " . date( "d-m-Y H:i:s.", filemtime( $percorso_cartella_dati . "/squadra_" . $outente ) ); else $ums = "&nbsp;";
    ...
    elseif ( isset( $opzione ) && $opzione == 2 ) {
        ...
        for ( $num1 = $num_iniziale; $num1 < $num_messaggi; $num1++ ) {
            ...
            if ( substr( "$messaggi[$num1]", 0, 13 ) == "Radio mercato" and $stato_mercato != "I" )
                $messmerc .= "$nome<br/>";
        } # fine for $num1
    ...
    elseif ( isset( $opzione ) && $opzione == 4 ) {
        ...
        for ( $num1 = 1; $num1 < 40; $num1++ ) {
            ...
            if ( ! @is_file( $percorso_cartella_dati . "/" . $giornata_controlla . "_" . $itorneo . "_0" ) )
                break; else {
        ...
        if ( $giornata_ultima )
            $file_giornata = @file( $percorso_cartella_dati . "/giornata" . $giornata . "_" . $itorneo . "_0" );
