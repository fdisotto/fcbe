...
if ( $_SESSION[ 'valido' ] == "SI" ) {
    ...
    if ( $ultima_giornata == "" )
        echo "<br/><br/><center><h4>Statistiche non presenti</h4></center><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>"; else {
        ...
        echo "<table width='100%' cellpadding='20' align='center' bgcolor='$sfondo_tab'>
	<caption>Riassunto $vedi_squadra</caption>
	<tr><td align='center'>";

        if ( @is_file( $file0 ) )
            echo "<img src='$file0' border='0' hspace='20' alt='Squadra' align='left' />";
        if ( @is_file( $file1 ) )
            echo "<img src='$file1' border='0' vspace='10' alt='Maglietta' /><br/>";
        if ( @is_file( $file2 ) )
            echo "<img src='$file2' border='0' vspace='10' alt='Logo' /><br/>";

        echo "<br/>Dati statistici aggiornati dalla giornata di campionato 01 alla giornata
$ultima_giornata</td></tr></table>
	<table width='100%' cellpadding='1' align='center' bgcolor='$sfondo_tab'>
	...
	<td class='testa'>Rigori T</td>
	<td class='testa'>Rigori S</td></tr>";

        #######################################
        if ( $stato_mercato != "I" and $ultima_giornata >= 1 )
            $voti = @file( $prima_parte_pos_file_voti . $ultima_giornata . ".txt" ); else $voti = file( "$percorso_cartella_dati/calciatori.txt" );
        ...
        if ( $ultima_giornata != "" )
            $cerca_squadra = file( "$prima_parte_pos_file_voti$ultima_giornata.txt" ); else $cerca_squadra = file( "$percorso_cartella_dati/calciatori.txt" );
        ...
        for ( $knum1 = 0; $knum1 < $num_cer_squ; $knum1++ ) {
            ...
            if ( $xsquadra == $vedi_squadra ) {
                ...
                if ( $statistiche == "SI" ) {
                    ...
                    echo "<td align='center'><a href='stat_calciatore.php?num_calciatore=$numero' class='user'>$numero</a></td>
	<td>$nome $csattivo</td>
