                    ...
                    <tr>
                        <td nowrap="nowrap" valign="top" align="left" height="32">
                            <input type="hidden" name="domains"
                                   value="sassarionline.net;fantacalciobazar.altervista.org;fantacalciobazar.sssr.it"/>
                        ...
                        <td nowrap="nowrap">
                            ...
                            <input type="hidden" name="cof"
                                   value="GALT:#0066CC;GL:1;DIV:#999999;VLC:336633;AH:center;BGC:FFFFFF;LBGC:FF9900;ALC:0066CC;LC:0066CC;T:000000;GFNT:666666;GIMP:666666;FORID:11"/>
                            ...
                            <table summary="">
                                <tr>
                                    <td>
                                        ...
                                        <label for="ss0" title="Ricerca nel Web"><font size="-1"
                                                                                       color="#000000">Web</font></label>
                                    </td>
                                    <td>
                                        <input type="radio" name="sitesearch" value="sassarionline.net" id="ss1"/>
                                        <label for="ss1" title="Cerca sassarionline.net"><font size="-1"
                                                                                               color="#000000">sassarionline.net</font></label>
                                    </td>
                                    <td>
                                        <input type="radio" name="sitesearch" value="fantacalciobazar.altervista.org"
                                               id="ss2"/>
                                        <label for="ss2" title="Cerca fantacalciobazar.altervista.org"><font size="-1"
                                                                                                             color="#000000">fantacalciobazar.altervista.org</font></label>
                                    </td>
                                    <td>
                                        <input type="radio" name="sitesearch" value="fantacalciobazar.sssr.it"
                                               id="ss3"/>
                                        <label for="ss3" title="Cerca fantacalciobazar.sssr.it"><font size="-1"
                                                                                                      color="#000000">fantacalciobazar.sssr.it</font></label>
                                    </td>
                                </tr>
                            </table>
                        </td>
