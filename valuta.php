...
$scrivi = "SI";
$filecambi = $percorso_cartella_dati."/cambi_".$_SESSION['utente'];
################################
...
echo "<meta http-equiv='refresh' content='1; url=cambi.php'>
<center><h3>Calciatore già selezionato</center></h3>";
$scrivi ="NO";
exit;
}
} # fine ciclo for
...
<a href='cambi.php' class='user1'>Prosegui</a></center><br/><br/><br/><br/><br/>
<meta http-equiv='refresh' content='0; url=cambi.php'>";
