...
tabella_squadre();
		...
		$num_calciatori_posseduti = 0;
			...
			$dati_calciatore = explode(",", $calciatori[$num1]);
				...
				#####################
					...
					else {$offri.="<input type='image' src='immagini/ok.png' name='submit' alt='Seleziona calciatore per cambio' /></form>"; 
							$csattivo = "";}
	...
	echo "<tr><td>Oggi &egrave; $adesso<br/>$frase_ug<br/><br/>";
		...
		if ($considera_fantasisti_come == "F") echo "<a href='tab_calciatori.php?ruolo_guarda=F' class='user'><b>&nbsp;F&nbsp;</b></a> - ";
		...
		if (@is_file("$percorso_cartella_dati/cambi_$nome_squadra")) $vedi_valuta = @file("$percorso_cartella_dati/cambi_$nome_squadra");
		...
		if ($controllo != 0) echo "<br/><br/><a href='valuta.php?eli_tutti=SI' class='user'><b>X</b></a> - Elimina tutti<br/><br/><font class='evidenziato'>Attenzione che la conferma dei cambi &egrave; definitiva ed irreversibile.<br/>La valutazione resta comunque memorizzata fino alla giornata successiva.</font>
		<center>
