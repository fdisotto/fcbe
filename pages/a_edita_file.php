...
<tr><td align='center'>";
            ...
            if ( is_file( $mod_file ) )
                $linee_dati = file( $mod_file ); else $linee_dati = "";
            $num_linee_dati = count( $linee_dati ?: [] );
            echo "<textarea name='n_contenuto_dati' rows='30' cols='120'>";
            for ( $num1 = 0; $num1 < $num_linee_dati; $num1++ )
                echo stripslashes( $linee_dati[ $num1 ] );
            echo "</textarea><br/>
