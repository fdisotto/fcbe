...
# Dati non configurabili da form
        ...
        if (@fopen(DATI_DIR . "/dati_gen.php", "w+")) {
            $file_dati = fopen(DATI_DIR . "/dati_gen.php", "wb+");
            ...
            exit;
        } # fine if (fopen("DATI_DIR/dati_gen.php","w+"))
        else {
		...
		<tr><td>Percorso cartella dati</td><td><input type='text' value='DATI_DIR' name='N_percorso_cartella_dati' size=40 maxlength=40 /></td><td>Indicare dove saranno registrati i dati; esempio <b>./dati</b></td></tr>
		...
		<tr><td>Cartella per upload</td><td><input type='text' value='$uploaddir' name='N_uploaddir' size=40 maxlength=40 /></td><td>Nome cartella dove uploadare i file dati dentro la cartelle <b>DATI_DIR</b>; per esempio <b>2006</b>.</td></tr>";
