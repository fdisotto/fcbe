...
if ( $_SESSION[ 'valido' ] == "SI" and $_SESSION[ 'permessi' ] >= 2 ) {
    ...
    if ( ! isset( $q ) ) {
        ...
        if ( $_SESSION[ 'permessi' ] >= 4 )
			...
			<a href='?q=3'>Gestione pagine</a>
			<a href='?q=6'>Aggiungi categoria</a>
			<a href='?q=8'>Gestione categorie</a>
			<!--
			<a href='?q=16'>Aggiungi sottocategoria</a>
			<a href='?q=18'>Gestione sottocategorie</a><br/>
			-->
