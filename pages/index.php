...
?>
    ...
    <div class="articoli_s">
        ...
        if ( $usa_cms == "SI" && isset( $_GET[ 'paginaid' ] ) && strip_tags( $_GET[ 'paginaid' ] ) ) {
            ...
            if ( trim( $messaggi[ 1 ] ) != "" )
                echo "<div class='slogan'>" . html_entity_decode( $messaggi[ 1 ] ) . "</div><div style='clear:both;'>&nbsp;</div>";

            if ( trim( $messaggi[ 3 ] ) or trim( $messaggi[ 4 ] ) )
                echo "<div>";
            if ( trim( $messaggi[ 3 ] ) != "" )
                echo "<div class='box1'>" . html_entity_decode( $messaggi[ 3 ] ) . "</div>";
            if ( trim( $messaggi[ 4 ] ) != "" )
                echo "<div class='box2'>" . html_entity_decode( $messaggi[ 4 ] ) . "</div>";
            if ( trim( $messaggi[ 3 ] ) or trim( $messaggi[ 4 ] ) )
                echo "</div>";
