...
$ruolo_guarda = $ruolo_guarda ?? "tutti";

$data_busta_chiusa = @join( '', @file( DATI_DIR . "/data_buste_" . $_SESSION[ 'torneo' ] . "_0.txt" ) );
$data_busta_precedente = @join( '', @file( DATI_DIR . "/data_buste_precedente_" . $_SESSION[ 'torneo' ] . "_0.txt" ) );
if ( $_SESSION[ 'valido' ] == "SI" or $escludi_controllo == "SI" ) {
    ...
    if ( $stato_mercato != "I" and $ultima_giornata >= 1 ) {
        ...
        $calciatori = file( DATI_DIR . "/calciatori.txt" );
    ...
    if ( $mercato_libero == "SI" )
        $layout .= "<th width='15%'>Costo iniziale</th>"; else $layout .= "<th width='15%'>Proprietario</th>";
    ...
    for ( $num1 = 0; $num1 < $num_calciatori; $num1++ ) {
        ...
        if ( $ruolo == $ruolo_guarda or $ruolo_guarda == "tutti" ) {
            ...
            $calciatori_merc = @file( DATI_DIR . "/mercato_" . $_SESSION[ 'torneo' ] . "_" . $_SESSION[ 'serie' ] . ".txt" ) ?: [];
            ...
            if ( $mercato_libero == "NO" ) {
                if ( $stato_mercato == "B" ) {
                    ...
                    if ( $ultima_riga[ 0 ] == "" and $n > 1 )
                        $diff_giri = $ultima_riga[ 1 ] - $data_busta_chiusa; else $diff_giri = 0;
                ...
                if ( ( ! isset( $xsquadra_ok ) || $xsquadra_ok == "NO" ) and $_SESSION[ 'utente' ] != $propr_c )
		...
		<td align='center'>" . intval( $valutazione ) . "</td>";
            ...
            if ( $mercato_libero == "SI" )
                $layout .= "<td align='center'>" . intval( $costo ) . "</td>"; else $layout .= "<td align='center'>&nbsp;$proprietario</td>";
