...
if ( $_SESSION[ 'valido' ] == "SI" ) {
    ...
    if ( ! isset( $_GET[ 'opzione' ] ) || ( $_GET[ 'opzione' ] != 2 and $_GET[ 'opzione' ] != 3 ) ) {
        $opzione = 3;
    } else {
    ...
    if ( $opzione == 2 ) {
        if ( $chiusura_giornata >= 1 ) {
            if ( ! $_GET[ 'nome_squadra' ] )
                $nome_squadra = "tutti"; else $nome_squadra = $_GET[ 'nome_squadra' ];
            ...
            for ( $num1 = 1; $num1 < $linee; $num1++ ) {
                ...
                if ( $nome_squadra == "tutti" or $nome_squadra == $outente ) {
                    ...
                    $linea_comprato_F = "";
                    $linea_comprato_A = "";
                    $calciatori = @file( DATI_DIR . "/mercato_" . $_SESSION[ 'torneo' ] . "_0.txt" );
                    $np = 0;
                    $nd = 0;
                    $nc = 0;
                    $nf = 0;
				...
				<tr><td align='center' colspan='$colspan'><b>Titolari</b></td></tr>";
                    ...
                    if ( $nome_squadra ) {
                        $messaggi = @file( DATI_DIR . "/registro_mercato_" . $_SESSION[ 'torneo' ] . "_0.txt" );
        ...
        } else echo "<h2>Giornata APERTA.<br/></h2><h3>Non &egrave; possibile visualizzare queste informazioni</h3><br/><br/>
    ...
    elseif ( $opzione == 3 ) {
        ...
        for ( $num1 = 1; $num1 < 40; $num1++ ) {
            ...
            if ( ! @is_file( DATI_DIR . "/" . $giornata_controlla . "_" . $_SESSION[ 'torneo' ] . "_0" ) )
                break; else {
                echo "<a href='?opzione=$opzione&amp;giornata=$num1'>&nbsp;$num1&nbsp;</a>&nbsp;";
        ...
        $file_giornata = [];
        if ( isset( $giornata ) && file_exists( DATI_DIR . "/giornata" . $giornata . "_" . $_SESSION[ 'torneo' ] . "_0" ) ) {
            $file_giornata = file( DATI_DIR . "/giornata" . $giornata . "_" . $_SESSION[ 'torneo' ] . "_0" );
        }
        ...
        if ( $tipo_campionato == "S" ) {
            echo "<table style='background-color: $sfondo_tab; margin-top:5px; margin-bottom:5px; padding: 2px; border: 1px solid $sfondo_tab2' width='50%' align='left' summary=''>";
            echo "<caption>Giornata $num_giornata_campionato</caption>";
            echo "<tr><th width='50%' align='center'><b>Partite</b></th><th align='center'><b>Risultato</b></th></tr>";
            $partite = "";
            $marcotori = "";
        ...
        if ( $voti_esistenti == "SI" ) {
            ...
            if ( $tipo_campionato != "N" ) {
                ...
                for ( $num1 = $g_inizio_campionato; $num1 <= $num_giornata; $num1++ ) {
                    ...
                    if ( is_file( DATI_DIR . "/" . $giornata_punti . "_" . $_SESSION[ 'torneo' ] . "_0" ) ) {
                        $file_giornata_p = file( DATI_DIR . "/" . $giornata_punti . "_" . $_SESSION[ 'torneo' ] . "_0" );
				...
				<th>Pos</th><th>Classifica: $num_giornata_campionato</th><th>Punti</th><th>Voti</th><th>Mod</th><th>Pg</th></tr>";
                arsort( $punti );
                reset( $punti );
                $posclas = 0;
