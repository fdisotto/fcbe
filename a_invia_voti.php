    ...
    if ( $gestione_email == "mail_anteprima" or $gestione_email == "mail_OK" ) {
        ...
        for ( $num1 = 1; $num1 < $linee; $num1++ ) {
            ...
            if ( $soprannome_squadra )
                $titolo .= "$soprannome_squadra"; else $titolo .= "Squadra";
	...
	TD.testa {
        ...
        if ( $gestione_email == "mail_OK" ) {
            ...
            if ( @mail( $destinatari, $oggetto, "$mail_formazione\n", $intestazioni ) )
                $azione = "La mail � stata inoltrata con successo."; else $azione = "Si sono verificati dei problemi nell'invio della mail.";
        } elseif ( $gestione_email == "mail_anteprima" )
            $azione = "<center><h3>Invio formazioni</h3><form method='post' action='a_invia_voti.php'>
        ...
        elseif ( $azione == "" )
            $azione = "Errore, Invio email non riuscito.";
    }
...
if ( $_SESSION[ 'permessi' ] == 5 ) {
    ...
    if ( isset( $gestione_email ) && ( $gestione_email == "mail_anteprima" or $gestione_email == "mail_OK" ) ) {
        ########################
        # Layout pagina
	...
	<tr><td class='testa' align='center' colspan='$colspan'><B>Titolari</B></td></tr>";
            ...
            for ( $num2 = 0; $num2 < $num_titolari; $num2++ ) {
                ...
                if ( isset( $linea_comprato_P[ $numero_titolare ] ) ) {
                    ...
                    $linea_comprato_P[ $numero_titolare ] = str_replace( "<tr><td>&nbsp;</td>", "<tr><td align=center>$num_pos</td>", $linea_comprato_P[ $numero_titolare ] );
                    $num_pos++;
                    $tab_titolari_P .= $linea_comprato_P[ $numero_titolare ];
                    $inserito[ $numero_titolare ] = "SI";
                } # fine if ($linea_comprato_P[$numero_titolare])
                if ( isset( $linea_comprato_D[ $numero_titolare ] ) ) {
                    ...
                    $linea_comprato_D[ $numero_titolare ] = str_replace( "<tr><td>&nbsp;</td>", "<tr><td align=center>$num_pos</td>", $linea_comprato_D[ $numero_titolare ] );
                    $num_pos++;
                    $tab_titolari_D .= $linea_comprato_D[ $numero_titolare ];
                    $inserito[ $numero_titolare ] = "SI";
                } # fine if ($linea_comprato_D[$numero_titolare])
                if ( isset( $linea_comprato_C[ $numero_titolare ] ) ) {
                    ...
                    $linea_comprato_C[ $numero_titolare ] = str_replace( "/<tr><td>&nbsp;</td>/", "<tr><td align=center>$num_pos</td>", $linea_comprato_C[ $numero_titolare ] );
                    $num_pos++;
                    $tab_titolari_C .= $linea_comprato_C[ $numero_titolare ];
                    $inserito[ $numero_titolare ] = "SI";
                } # fine if ($linea_comprato_C[$numero_titolare])
                if ( isset( $linea_comprato_F[ $numero_titolare ] ) ) {
                    ...
                    $linea_comprato_F[ $numero_titolare ] = str_replace( "<tr><td>&nbsp;</td>", "<tr><td align=center>$num_pos</td>", $linea_comprato_F[ $numero_titolare ] );
                    $num_pos++;
                    $tab_titolari_F .= $linea_comprato_F[ $numero_titolare ];
                    $inserito[ $numero_titolare ] = "SI";
                } # fine if ($linea_comprato_F[$numero_titolare])
                if ( isset( $linea_comprato_A[ $numero_titolare ] ) ) {
                    ...
                    $linea_comprato_A[ $numero_titolare ] = str_replace( "<tr><td>&nbsp;</td>", "<tr><td align=center>$num_pos</td>", $linea_comprato_A[ $numero_titolare ] );
                    $num_pos++;
                    $tab_titolari_A .= $linea_comprato_A[ $numero_titolare ];
                    $inserito[ $numero_titolare ] = "SI";
                } # fine if ($linea_comprato_A[$numero_titolare])
            ...
            for ( $num2 = 0; $num2 < $num_panchinari; $num2++ ) {
                ...
                if ( isset( $linea_comprato_P[ $numero_panchinaro ] ) ) {
                    ...
                    $linea_comprato_P[ $numero_panchinaro ] = str_replace( "<tr><td>&nbsp;</td>", "<tr><td align=center>$num_pos</td>", $linea_comprato_P[ $numero_panchinaro ] );
                    $num_pos++;
                    $tab_panchinari .= $linea_comprato_P[ $numero_panchinaro ];
                    $inserito[ $numero_panchinaro ] = "SI";
                } # fine if ($linea_comprato_P[$numero_panchinaro])
                if ( isset( $linea_comprato_D[ $numero_panchinaro ] ) ) {
                    ...
                    $linea_comprato_D[ $numero_panchinaro ] = str_replace( "<tr><td>&nbsp;</td>", "<tr><td align=center>$num_pos</td>", $linea_comprato_D[ $numero_panchinaro ] );
                    $num_pos++;
                    $tab_panchinari .= $linea_comprato_D[ $numero_panchinaro ];
                    $inserito[ $numero_panchinaro ] = "SI";
                } # fine if ($linea_comprato_D[$numero_panchinaro])
                if ( isset( $linea_comprato_C[ $numero_panchinaro ] ) ) {
                    ...
                    $linea_comprato_C[ $numero_panchinaro ] = str_replace( "/<tr><td>&nbsp;</td>/", "<tr><td align=center>$num_pos</td>", $linea_comprato_C[ $numero_panchinaro ] );
                    $num_pos++;
                    $tab_panchinari .= $linea_comprato_C[ $numero_panchinaro ];
                    $inserito[ $numero_panchinaro ] = "SI";
                } # fine if ($linea_comprato_C[$numero_panchinaro])
                if ( isset( $linea_comprato_F[ $numero_panchinaro ] ) ) {
                    ...
                    $linea_comprato_F[ $numero_panchinaro ] = str_replace( "<tr><td>&nbsp;</td>", "<tr><td align=center>$num_pos</td>", $linea_comprato_F[ $numero_panchinaro ] );
                    $num_pos++;
                    $tab_panchinari .= $linea_comprato_F[ $numero_panchinaro ];
                    $inserito[ $numero_panchinaro ] = "SI";
                } # fine if ($linea_comprato_F[$numero_panchinaro])
                if ( isset( $linea_comprato_A[ $numero_panchinaro ] ) ) {
                    ...
                    $linea_comprato_A[ $numero_panchinaro ] = str_replace( "<tr><td>&nbsp;</td>", "<tr><td align=center>$num_pos</td>", $linea_comprato_A[ $numero_panchinaro ] );
                    $num_pos++;
                    $tab_panchinari .= $linea_comprato_A[ $numero_panchinaro ];
                    $inserito[ $numero_panchinaro ] = "SI";
                } # fine if ($linea_comprato_A[$numero_panchinaro])
            ...
            for ( $num2 = 0; $num2 < $num_calciatori; $num2++ ) {
                ...
                if ( $inserito[ $numero_fuori ] != "SI" ) {
                    if ( isset( $linea_comprato_P[ $numero_fuori ] ) ) {
                        $linea_comprato_P[ $numero_fuori ] = str_replace( "value=\"fuori\"", "value=\"fuori\" checked", $linea_comprato_P[ $numero_fuori ] );
                        $tab_fuori_P .= $linea_comprato_P[ $numero_fuori ];
                        $inserito[ $numero_fuori ] = "SI";
                    } # fine if ($linea_comprato_P[$numero_fuori])
                    if ( isset( $linea_comprato_D[ $numero_fuori ] ) ) {
                        $linea_comprato_D[ $numero_fuori ] = str_replace( "value=\"fuori\"", "value=\"fuori\" checked", $linea_comprato_D[ $numero_fuori ] );
                        $tab_fuori_D .= $linea_comprato_D[ $numero_fuori ];
                        $inserito[ $numero_fuori ] = "SI";
                    } # fine if ($linea_comprato_D[$numero_fuori])
                    if ( isset( $linea_comprato_C[ $numero_fuori ] ) ) {
                        $linea_comprato_C[ $numero_fuori ] = str_replace( "value=\"fuori\"", "value=\"fuori\" checked", $linea_comprato_C[ $numero_fuori ] );
                        $tab_fuori_C .= $linea_comprato_C[ $numero_fuori ];
                        $inserito[ $numero_fuori ] = "SI";
                    } # fine if ($linea_comprato_C[$numero_fuori])
                    if ( isset( $linea_comprato_F[ $numero_fuori ] ) ) {
                        $linea_comprato_F[ $numero_fuori ] = str_replace( "value=\"fuori\"", "value=\"fuori\" checked", $linea_comprato_F[ $numero_fuori ] );
                        $tab_fuori_F .= $linea_comprato_F[ $numero_fuori ];
                        $inserito[ $numero_fuori ] = "SI";
                    } # fine if ($linea_comprato_F[$numero_fuori])
                    if ( isset( $linea_comprato_A[ $numero_fuori ] ) ) {
                        $linea_comprato_A[ $numero_fuori ] = str_replace( "value=\"fuori\"", "value=\"fuori\" checked", $linea_comprato_A[ $numero_fuori ] );
                        $tab_fuori_A .= $linea_comprato_A[ $numero_fuori ];
                        $inserito[ $numero_fuori ] = "SI";
                    } # fine if ($linea_comprato_A[$numero_fuori])
                } # fine if ($inserito[$num_fuori] != "SI")
	...
	TD.testa {
        ...
        if ( $gestione_email == "mail_OK" ) {
            ...
            if ( @mail( $destinatari, $oggetto, "$mail_formazione\n", $intestazioni ) ) {
                $azione = "La mail è stata inoltrata con successo.";
            } else {
    ...
    ###############################
        ...
        $azione = "<h3>Invio email con formazioni</h3>
        $frase<br>
        <form method=\"post\" action=\"a_invia_voti.php\">
        <input type=\"hidden\" name=\"gestione_email\" value=\"mail_anteprima\">
