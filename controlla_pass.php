...
if ( $_SESSION[ 'valido' ] != "SI" and $_SESSION[ 'ec' ] != "SI" ) {
    ...
    exit;
} elseif ( $_SESSION[ 'valido' ] == "SI" && isset( $_SESSION[ 'csn' ] ) && $_SESSION[ 'csn' ] == $_SERVER[ 'SERVER_NAME' ] ) {
...
if ( $_SESSION[ 'utente' ] != $admin_user and $_SESSION[ 'valido' ] == "SI" ) {
    ...
    if ( is_file( $percorso_cartella_dati . "/data_chigio.txt" ) )
        $data_chigio = @file( $percorso_cartella_dati . "/data_chigio.txt" ); else $data_chigio[ 0 ] = $data_attuale;
