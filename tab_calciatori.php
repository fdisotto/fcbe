            ...
            for ( $num2 = 0; $num2 < $num_calciatori_merc; $num2++ ) {
                ...
                if ( $numero_merc == $numero ) {
                    ...
                    if ( $sec_restanti > 1 ) {
                        ...
                        if ( $giorni > 0 ) {
                            if ( $giorni > 1 )
                                $tempo_restante .= $giorni . "gg"; else $tempo_restante .= $giorni . "gg";
                        }
                        if ( $ore > 0 ) {
                            if ( $tempo_restante != "" )
                                $tempo_restante .= ":";
                            if ( $ore > 1 )
                                $tempo_restante .= $ore . "o"; else $tempo_restante .= $ore . "o";
                        }
                        if ( $minuti > 0 ) {
                            if ( $tempo_restante != "" )
                                $tempo_restante .= ":";
                            if ( $minuti > 1 )
                                $tempo_restante .= $minuti . "m"; else $tempo_restante .= $minuti . "m";
                        }
