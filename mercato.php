...
if ( $_SESSION[ 'valido' ] == "SI" and $_SESSION[ 'utente' ] != $admin_user ) {
    ...
    */
    ...
    if ( $max_calciatori != $num_calciatori_posseduti ) {
        ...
        if ( @is_file( $percorso_cartella_dati . "/editoriale.txt" ) )
            $linee_editoriale = @file( $percorso_cartella_dati . "/editoriale.txt" ) ?: []; else $linee_editoriale = [];
        ...
        if ( $stato_mercato == "I" or $stato_mercato == "B" or $stato_mercato == "R" )
            echo "<br />Lista calciatori del: " . date( "d-m-Y H:i:s.", filemtime( $percorso_cartella_dati . "/calciatori.txt" ) ) . "<br />";
    ...
    for ( $num1 = 0; $num1 < $num_linee_file_giornata; $num1++ ) {
        ...
        if ( ! empty( $leggendo_modificatore ) && $leggendo_modificatore == "SI" ) {
