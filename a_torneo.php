    ...
    if (isset($inserimento) && $inserimento == "scrivi") {
        if ($azione == "nuovo") {
            ...
            for ($num1 = 1; $num1 < $num_tornei; $num1++) {
                ...
                if ($id == $otid) $tornei[$num1] = $stringa;
            } # fine for $num1
        ...
        if (!isset($itorneo)) {
            if (!@is_file($percorso_cartella_dati . "/tornei.php")) {
                ...
                if (@chmod($percorso_cartella_dati . "/tornei.php", 0664)) echo "CHMOD 664 impostato!<br />";
                unset ($ini_file, $fp);
            }
            ...
            if ($azione == "nuovo") echo "<input type='hidden' name='azione' value='nuovo' />";
            else echo "<input type='hidden' name='azione' value='modifica' />";
            ?>
        <table width='100%' border='1' cellpadding='10' bgcolor='<?php echo $sfondo_tab; ?>'>
            ...
            <tr>
                ...
                <td align="left">Lo stato del mercato pu&ograve; essere:<br/>
            ...
            <tr>
                ...
                <td align="center">
                    <select name="N_otmercato_libero">
                        <option value="SI" <?php if ($otmercato_libero == "SI") echo "selected"; ?> > Mercato libero
                        </option>
                        <option value="NO" <?php if ($otmercato_libero == "NO") echo "selected"; ?> > Asta iniziale
                        </option>
                    </select></td>
            ...
            <tr>
                ...
                <td align="center">
                    <select name="N_ottipo_calcolo">
                        ...
                        <option value="P" <?php if ($ottipo_calcolo == "P") echo "selected"; ?> > Somma dei punti
                        </option>
                        <option value="S" <?php if ($ottipo_calcolo == "S") echo "selected"; ?> > Scontri diretti
                        </option>
                        <option value="N" <?php if ($ottipo_calcolo == "N") echo "selected"; ?> > Nessun calcolo
                        </option>
                    </select></td>
            ...
            <tr>
                ...
                <td align="center">
                    <select name="N_otmodificatore_difesa">
                        <option value="SI" <?php if ($otmodificatore_difesa == "SI") echo "selected"; ?> > SI</option>
                        <option value="NO" <?php if ($otmodificatore_difesa == "NO") echo "selected"; ?> > NO</option>
                    </select></td>
            ...
            <tr>
                ...
                <td align="center">
                    <select name="N_otpanchina_fissa">
                        <option value="SI" <?php if ($otpanchina_fissa == "SI") echo "selected"; ?> > SI</option>
                        <option value="NO" <?php if ($otpanchina_fissa == "NO") echo "selected"; ?> > NO</option>
                    </select></td>
            ...
            <tr>
                ...
                <td align="center">
                    <select name="N_otsostituisci_per_ruolo">
                        <option value="SI" <?php if ($otsostituisci_per_ruolo == "SI") echo "selected"; ?> > SI</option>
                        <option value="NO" <?php if ($otsostituisci_per_ruolo == "NO") echo "selected"; ?> > NO</option>
                    </select></td>
                <td align="left">Nel caso in cui un calciatore titolare non prenda voto la sostituzione con il
                    panchinaro avviene per ruolo. <b>Selezionare almeno una tra le opzioni di sostituzione (<u>per ruolo
                            e per schema</u>), altrimenti non entreranno panchinari in caso di possibile
                        sostituzione</b>.
                </td>
            </tr>
            <tr>
                ...
                <td align="center">
                    <select name="N_otsostituisci_per_schema">
                        <option value="SI" <?php if ($otsostituisci_per_schema == "SI") echo "selected"; ?> > SI
                        </option>
                        <option value="NO" <?php if ($otsostituisci_per_schema == "NO") echo "selected"; ?> > NO
                        </option>
                    </select></td>
            ...
            <tr>
                ...
                <td align="center">
                    <select name="N_otsostituisci_fantasisti_come_centrocampisti">
                        <option value="SI" <?php if ($otsostituisci_fantasisti_come_centrocampisti == "SI") echo "selected"; ?> >
                            SI
                        </option>
                        <option value="NO" <?php if ($otsostituisci_fantasisti_come_centrocampisti == "NO") echo "selected"; ?> >
                            NO
                        </option>
                    </select></td>
            ...
            if (isset($otmercato_libero) && $otmercato_libero == "SI") {
				...
				<option value='0'";
                if ($otrip_cambi_durata == "0") echo "selected";
                echo " > Una giornata</option>
				<option value='1'";
                if ($otrip_cambi_durata == "1") echo "selected";
                ...
                $checkSI = "";
                $checkNO = "";
                if ($otreset_scadenza == "SI") $checkSI = "checked";
                ...
                $checkSI = "";
                $checkNO = "";
                if ($otscambio_con_soldi == "SI") $checkSI = "checked";
                else $checkNO = "checked";
                ...
                $checkSI = "";
                $checkNO = "";
                if ($otvendi_costo == "SI") $checkSI = "checked";
                else $checkNO = "checked";
            ...
            if (isset($ottipo_calcolo) && ($ottipo_calcolo == "P" || $ottipo_calcolo == "S")) {
                ...
                echo " > Media</option>
				<option value='A'";
                if ($otpunti_pareggio == "A") echo "selected";
                echo " > Alta</option>
				<option value='B'";
            ...
            echo "</table>";
            if (!$otmercato_libero) echo "<p align='center'><b>Dopo aver confermato i dati sar&agrave; possibile configurare le specifiche del torneo!</b></p>";
            echo "<p align='center'>
			<input type='hidden' name='inserimento' value='scrivi' />
