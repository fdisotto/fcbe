...
if ( $_SESSION[ 'valido' ] == "SI" and $_SESSION[ 'permessi' ] >= 4 ) {
    ...
    for ( $num = 1; $num < $num_tornei; $num++ ) {
        ...
        if ( strlen( $num_giornata_voti ) == 1 )
            $num_giornata_voti = "0" . $num_giornata_voti;
        ...
        if ( @is_file( "$percorso_cartella_voti/voti$num_giornata_voti.txt" ) )
            $voti = @file( "$percorso_cartella_voti/voti$num_giornata_voti.txt" ); else {
        ...
        for ( $num1 = 0; $num1 < $num_voti; $num1++ ) {
            ...
            if ( $DEBUG == "SI" )
                echo "$num_giornata_voti $num_calciatore - FV = $voto_tot[$num_calciatore] V = $voto_giornale[$num_calciatore] Presenza = $presenza[$num_calciatore] Entrato = $entrato[$num_calciatore] <br />";

            # giocatore SV con voto giornale = 0 - sei d'ufficio
            if ( intval( $voto_giornale[ $num_calciatore ] ) == 0 and INTVAL( $giocasv[ $num_calciatore ] ) == 1 )
                $voto_giornale[ $num_calciatore ] = 6;

            # partita rinviata - sei d'ufficio
            if ( intval( $voto_tot[ $num_calciatore ] ) == 6 and intval( $voto_giornale[ $num_calciatore ] ) == 0 and INTVAL( $presenza[ $num_calciatore ] ) == 1 and INTVAL( $entrato[ $num_calciatore ] ) == 0 )
                $voto_giornale[ $num_calciatore ] = 6;
        ...
        # leggo le informazioni gi� presenti in $giornata
        ...
        for ( $num1 = 0; $num1 < $num_linee_file_giornata; $num1++ ) {
            ...
            if ( ! empty( $leggendo_formazioni ) && $leggendo_formazioni == "SI" ) {
                if ( $linea == "#@& formazione #@&" )
                    $outente = "";
            ...
            if ( ! empty( $leggendo_scontri ) && $leggendo_scontri == "SI" ) {
        ...
        if ( $continuare != "NO" ) {
            ...
            for ( $num1 = 1; $num1 < $linee; $num1++ ) {
                ...
                if ( $opermessi >= 0 ) {
                    ...
                    for ( $num2 = 0; $num2 < $num_linee_formazione; $num2++ ) {
                        if ( $DEBUG == "SI" )
                            echo ${$formazione}[ $num2 ] . "<br>";

                        if ( ! ${$formazione}[ $num2 ] )
                            break;

                        if ( togli_acapo( ${$formazione}[ $num2 ] ) == "" )
                            break;
                        ...
                        if ( $voto_tot[ $num_calciatore ] == 0 and $voto_giornale[ $num_calciatore ] == 0 ) {
                            ...
                            if ( $DEBUG == "SI" )
                                echo "T: " . $voti_tot[ $outente ] . " = " . $voti_tot[ $outente ] . " + " . $voto_tot[ $num_calciatore ] . "<br />";
                            $nome_calc = str_replace( '&#039;', '\'', htmlentities( $dati_calciatore[ 1 ], ENT_QUOTES ) );
                            ${$formazione}[ $num2 ] = preg_replace( "/$nome_calc/", "<b>$nome_calc</b>", ${$formazione}[ $num2 ] );
                    ...
                    if ( $sostituisci_per_ruolo == "SI" ) {
                        for ( $num2 = $linea_inizio_panchina; $num2 < $num_linee_formazione; $num2++ ) {
                            ...
                            if ( $voto_tot[ $num_calciatore ] != 0 or $voto_giornale[ $num_calciatore ] != 0 ) {
                                ...
                                if ( $$nome_sostituisci >= 1 and $entrati_dalla_panchina < $max_entrate_dalla_panchina ) {
                                    if ( $DEBUG == "SI" )
                                        echo "P: " . $voti_tot[ $outente ] . " = " . $voti_tot[ $outente ] . " + " . $voto_tot[ $num_calciatore ] . "<br/>";
                                    $nome_calc = str_replace( '&#039;', '\'', htmlentities( $dati_calciatore[ 1 ], ENT_QUOTES ) );
                                    ${$formazione}[ $num2 ] = preg_replace( "/$nome_calc/", "<b>$nome_calc</b>", ${$formazione}[ $num2 ] );
                                    $voti_tot[ $outente ] = $voti_tot[ $outente ] + $voto_tot[ $num_calciatore ];
                        ...
                        if ( $sostituisci_fantasisti_come_centrocampisti == "SI" ) {
                            ...
                            for ( $num2 = $linea_inizio_panchina; $num2 < $num_linee_formazione; $num2++ ) {
                                if ( $sostituisci_CF < 1 or $entrati_dalla_panchina >= $max_entrate_dalla_panchina )
                                    break;
                                if ( ! ${$formazione}[ $num2 ] )
                                    break;
                                if ( togli_acapo( ${$formazione}[ $num2 ] ) == "" )
                                ...
                                if ( isset( $calciatore_entrato[ $num_calciatore ] ) && $calciatore_entrato[ $num_calciatore ] != "SI" ) {
                                    if ( $voto_tot[ $num_calciatore ] != 0 or $voto_giornale[ $num_calciatore ] != 0 ) {
                                        $ruolo_calc = $dati_calciatore[ 2 ];
                                        $ruolo_calc = togli_acapo( $ruolo_calc );
                    ...
                    if ( $sostituisci_per_schema == "SI" ) {
                        for ( $num2 = $linea_inizio_panchina; $num2 < $num_linee_formazione; $num2++ ) {
                            if ( $entrati_dalla_panchina >= $num_sostituisci or $entrati_dalla_panchina >= $max_entrate_dalla_panchina )
                                break;
                            if ( ! ${$formazione}[ $num2 ] )
                                break;
                            if ( togli_acapo( ${$formazione}[ $num2 ] ) == "" )
                            ...
                            if ( isset( $calciatore_entrato[ $num_calciatore ] ) && $calciatore_entrato[ $num_calciatore ] != "SI" ) {
                                if ( $voto_tot[ $num_calciatore ] != 0 or $voto_giornale[ $num_calciatore ] != 0 ) {
                                    ...
                                    for ( $num3 = 0; $num3 < $num_schemi; $num3++ ) {
                                        ...
                                        if ( strlen( $schema ) == 4 )
                                            $schema = substr_replace( $schema, "0", 3, 0 );

                                        $trovato = "SI";

                                        for ( $num4 = 0; $num4 <= 4; $num4++ ) {
                                            if ( substr( $schema_prova, $num4, 1 ) > substr( $schema, $num4, 1 ) )
                                                $trovato = "NO";
                                        } # fine for $num4
                ...
                for ( $num1 = 1; $num1 < $linee; $num1++ ) {
                    ...
                    if ( $opermessi >= 0 ) {
                        ...
                        for ( $num2 = 0; $num2 < $num_linee_formaz; $num2++ ) {
                            ...
                            if ( $gio_entrato == "<B>" or $gio_entrato == "<b>" )
                                $gio_entr_val = "Entrato";
                        ...
                        if ( $voti_val_portiere != 0 and $portiere_entra == 1 ) {
                            if ( $num_mod_dif >= 4 ) {
                                ...
                                if ( $media_voti >= 7 )
                                    $modificatore[ $outente ] = 6; elseif ( $media_voti >= 6.5 and $media_voti < 7 )
                                    $modificatore[ $outente ] = 3;
                                elseif ( $media_voti >= 6 and $media_voti < 6.5 )
                                    $modificatore[ $outente ] = 1;
            ...
            */
            ...
            for ( $num1 = 1; $num1 < $linee; $num1++ ) {
                @list( $outente, $opass, $opermessi, $oemail, $ourl, $osquadra, $otorneo, $oserie, $ocitta, $ocrediti, $ovariazioni, $ocambi, $oreg ) = explode( "<del>", $file[ $num1 ] );
                if ( $opermessi >= 0 )
                    $nuovo_filegiornata .= $outente . "##@@&&" . $voti_tot[ $outente ] . "\r\n";
            } # fine for $num1
            ...
            if ( $modificatore_difesa == "SI" ) {
                ...
                for ( $num1 = 1; $num1 < $linee; $num1++ ) {
                    @list( $outente, $opass, $opermessi, $oemail, $ourl, $osquadra, $otorneo, $oserie, $ocitta, $ocrediti, $ovariazioni, $ocambi, $oreg ) = explode( "<del>", $file[ $num1 ] );
                    if ( $opermessi >= 0 )
                        $nuovo_filegiornata .= $outente . "##@@&&" . $modificatore[ $outente ] . "\r\n";
                } # fine for $num1
            ...
            if ( $tipo_campionato == "P" ) {
                ...
                for ( $num1 = 1; $num1 <= $num_giocatori; $num1++ ) {
                    ...
                    if ( $punti_pareggio == "A" ) {
                        $verifica_num = preg_replace( "/[0-9]/", "", $punti_posizione[ $pos_alta - 1 ] );
                        if ( $verifica_num != "" or $punti_posizione[ $pos_alta - 1 ] == "" )
                            $punti_assegnati = 0; else {
                            $num2 = $pos_alta;
                            $diff = 1;
                            $punti_set = 0;
                            for ( $num2; $num2 <= $num_giocatori; $num2++ ) {
                                if ( $voti_posizione[ $pos_alta - $diff ] == $voti_posizione[ $pos_alta ] ) {
                                    ...
                                    if ( $punti_set == 0 )
                                        $punti_assegnati = $punti_posizione[ $pos_alta ];
                                }
                                $diff++;
                            }
                        }
                    ...
                    elseif ( $punti_pareggio == "B" ) {
                        $verifica_num = preg_replace( "/[0-9]/", "", $punti_posizione[ $pos_bassa - 1 ] );
                        if ( $verifica_num != "" or $punti_posizione[ $pos_bassa - 1 ] == "" )
                            $punti_assegnati = 0; else $punti_assegnati = $punti_posizione[ $pos_bassa - 1 ];
                        ...
                        for ( $num2 = $pos_alta - 1; $num2 <= $pos_bassa - 1; $num2++ ) {
                            $verifica_num = preg_replace( "/[0-9]/", "", $punti_posizione[ $num2 ] );
                            if ( $verifica_num != "" or $punti_posizione[ $num2 ] == "" )
                                $punti_somma = 0; else $punti_somma = $punti_posizione[ $num2 ];
                ...
                for ( $num1 = 1; $num1 < $linee; $num1++ ) {
                    @list( $outente, $opass, $opermessi, $oemail, $ourl, $osquadra, $otorneo, $oserie, $ocitta, $ocrediti, $ovariazioni, $ocambi, $oreg ) = explode( "<del>", $file[ $num1 ] );
                    if ( $opermessi >= 0 )
                        $nuovo_filegiornata .= $outente . "##@@&&" . $punti_tot[ $outente ] . "\r\n";
                } # fine for $num1
                $nuovo_filegiornata .= "#@& fine punteggi #@&\r\n";
            ...
            if ( $tipo_campionato == "S" ) {
                ...
                for ( $num1 = 0; $num1 < $num_partite; $num1++ ) {
                    ...
                    if ( $gol1 == $gol2 && $gol1 > 0 && $differenza_punti_a_parita_gol > 0 ) {
                        if ( $voti_tot[ $partita[ 0 ] ] >= $voti_tot[ $partita[ 1 ] ] + $differenza_punti_a_parita_gol )
                            $gol1 = $gol1 + 1; elseif ( $voti_tot[ $partita[ 1 ] ] >= $voti_tot[ $partita[ 0 ] ] + $differenza_punti_a_parita_gol )
                            $gol2 = $gol2 + 1;
                    }

                    if ( $gol1 == 0 && $gol2 == 0 && $differenza_punti_zero_a_zero > 0 ) {
                        if ( $voti_tot[ $partita[ 0 ] ] >= $voti_tot[ $partita[ 1 ] ] + $differenza_punti_zero_a_zero )
                            $gol1 = $gol1 + 1; elseif ( $voti_tot[ $partita[ 1 ] ] >= $voti_tot[ $partita[ 0 ] ] + $differenza_punti_zero_a_zero )
                            $gol2 = $gol2 + 1;
                    }
