...
include("./header.php");
	...
	$chiusura_giornata = INTVAL(@file($percorso_cartella_dati."/chiusura_giornata.txt"));
		...
		echo "<table width='100%' cellpadding='5' align='center' bgcolor='$sfondo_tab'>
		...
		##############################################
		# Verifica se il giocatore &egrave; in compropriet� #
		##############################################
		...
		echo "<br/><br/><table width='50%' border=1 cellspacing=2 cellpadding=5 bgcolor='$sfondo_tab1'>";
