...
if (@$_SESSION['valido'] == "SI" and $_SESSION['utente'] == $admin_user) {
    ...
    if ($usa_cms == "SI") echo "<a href='./a_sito.php' title='Gestione contenuti testuali'>cms</a>";
    ...
    if ($stato_mercato == "A" or $stato_mercato == "P" or $stato_mercato == "C" or $stato_mercato == "S") {
        ...
        if ($ottipo_calcolo == "S") echo "<a href='./calendario.php'>Calendario</a>";
        if ($mercato_libero == "NO" or $ottipo_calcolo == "S") echo "<a href='./classifica.php'>Classifica</a>";
    }
