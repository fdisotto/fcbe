		...
		if ($_POST['offri_scambio']) {
			...
			for ($num1 = 0 ; $num1 < $num_calciatori_scambiabili ; $num1++) {
				...
				if ($gia_offerti_utente[$calciatore_scambio_utente] == "SI") {
					$scambiare = "NO";
					echo "Hai offerto pi� volte lo stesso calciatore.<br />";
				...
				if ($gia_offerti_altro[$calciatore_scambio_altro] == "SI") {
					$scambiare = "NO";
					echo "Hai richiesto pi� volte lo stesso calciatore.<br />";
			...
			if ($num_calciatori_dopo > $max_calciatori) {
				$scambiare = "NO";
				echo "Dopo lo scambio avresti pi� di $max_calciatori calciatori.<br />";
			...
			if ($soldi_scambio_utente > $soldi_spendibili) {
				$scambiare = "NO";
				echo "Hai offerto pi� crediti di quelli da te posseduti.<br />";
			...
			if ($soldi_scambio_altro > $soldi_spendibili_altro) {
				$scambiare = "NO";
				echo "Hai richiesto a ".$altro_utente." pi� crediti di quelli disponibili.<br />";
