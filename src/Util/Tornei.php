        ...
        if ( file_exists( $percorso_file ) ) {
            ...
            foreach ( $rows as $idx => $row ) {
                ...
                $tornei[] = new TorneoModel( [
                    ...
                    'vendi_costo'                                => $temp[ 33 ],
                    'percentuale_vendita'                        => (float)$temp[ 34 ],
                    'soglia_voti_primo_gol'                      => (float)$temp[ 35 ],
                    'incremento_voti_gol_successivi'             => (float)$temp[ 36 ],
                    'voti_bonus_in_casa'                         => (float)$temp[ 37 ],
                    'punti_partita_vinta'                        => (float)$temp[ 38 ],
                    'punti_partita_pareggiata'                   => (float)$temp[ 39 ],
                    'punti_partita_persa'                        => (float)$temp[ 40 ],
                    'differenza_punti_a_parita_gol'              => (float)$temp[ 41 ],
                    'differenza_punti_zero_a_zero'               => (float)$temp[ 42 ],
                    'min_num_titolari_in_formazione'             => (int)$temp[ 43 ],
